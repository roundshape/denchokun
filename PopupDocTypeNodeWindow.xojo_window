#tag DesktopWindow
Begin DesktopWindow PopupDocTypeNodeWindow
   Backdrop        =   0
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  var ret as string = self.CreateDealTypeList()
		  if ret <> "OK" then
		    MessageBox ret
		  end if
		End Sub
...
#tag Events TextList
	#tag Event
		Sub DoublePressed()
		  ...
		  self.SelectedValue = me.SelectedRowValue
		  self.Close
		End Sub
	#tag EndEvent
#tag EndEvents
